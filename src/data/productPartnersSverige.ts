...
export const PRODUCT_PARTNERS_SVERIGE: ProductPartnersSverigeConfig[] = [
  {
    ...
    intro:
      "Här hittar du Microsoft-partners i Sverige som implementerar och förvaltar Dynamics 365 Business Central. Listan visar profilerade partners på d365.se, sorterade efter namn. Klicka på en partner för att läsa om kompetens, branscher, referenser och hur de tar betalt.",
    faq: [
      {
