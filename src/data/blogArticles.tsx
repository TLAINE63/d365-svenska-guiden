    ...
    bigFiveFaq: [
      {
        ...
        answer:
          "Licenskostnaden styrs av plattformsval och antal användare. Business Central Premium (som inkluderar tillverkning) ligger på cirka 1 215 kr/användare/månad. Finance kostar {{price:finance:short}} och Supply Chain Management cirka 2 050 kr/användare/månad — relevant för större tillverkare med avancerad MES-, kvalitets- och spårbarhetslogik. Field Service ligger på {{price:field-service:short}}.\n\nImplementationskostnaden för ett medelstort tillverkningsföretag landar typiskt i intervallet 1 200 000 – 5 000 000 kr beroende på antal anläggningar, integrationer mot MES, PLM och CAD samt behov av branschspecifika tillägg. Räkna också med löpande förvaltning på 10–20 % av implementationen per år.",
      },
      {
    ...
    bigFiveFaq: [
      {
        ...
        answer:
          "Licenskostnaden styrs av plattformsval och antal användare. Finance kostar {{price:finance:short}} och Supply Chain Management cirka 2 050 kr/användare/månad — relevant för större offentliga organisationer med upphandlings- och anläggningsregister. Customer Service Enterprise ligger på {{price:customer-service-enterprise:short}}, Field Service på {{price:field-service:short}} och Customer Insights (Data + Journeys) på {{price:customer-insights:default}}. Microsoft erbjuder särskild prissättning för offentlig sektor.\n\nImplementationskostnaden för en medelstor offentlig organisation landar typiskt i intervallet 1 000 000 – 5 000 000 kr beroende på integrationer mot diariesystem, ekonomisystem, e-arkiv och behov av branschspecifika tillägg. Räkna också med löpande förvaltning på 10–20 % av implementationen per år.",
      },
      {
