...
export const PRODUCT_STANDARD_SECTIONS: Record<string, StandardSectionsData> = {
  "business-central": {
    ...
    partnerMatters: {
      processDesign: "Hur du hanterar order-till-faktura, inköp och lager sätter ramen för hela implementationen. Fel processdesign märks först efter go-live.",
      ...
      dataModel: "Artikel-, kund- och dimensionsstruktur är svår att ändra senare. Partnern bör utmana dig på detta tidigt.",
    ...
    pitfalls: [
      ...
      "Man väljer partner utan referenser från liknande bransch – och betalar för att de ska lära sig på din bekostnad.",
    ],
  },
  ...
  "sales": {
    ...
    partnerMatters: {
      processDesign: "Säljprocess, leadkvalificering och pipeline-stadier måste matcha hur du faktiskt säljer – inte hur Microsofts demo ser ut.",
      ...
      dataModel: "Konto/kontakt/lead-modellen ser olika ut för B2B-långa cykler vs transaktionsförsäljning. Partnern måste förstå din affär.",
  ...
  "customer-service": {
    ...
    partnerMatters: {
      processDesign: "Köer, SLA, routing-regler och eskaleringsvägar måste matcha din supportorganisation – annars blir systemet ett hinder i stället för stöd.",
      ...
      dataModel: "Ärende-, kontakt- och kontomodell måste fungera ihop med Sales och Marketing – annars hamnar du i datasilos igen.",
    ...
    pitfalls: [
      ...
      "Man hoppar över kunskapsbasen – Copilot blir då lika svag som din dokumentation.",
  ...
  "contact-center": {
    ...
    partnerMatters: {
      processDesign: "IVR-flöden, routing och eskalering måste matcha din supportorganisation – fel design ger fler eskaleringar, inte färre.",
