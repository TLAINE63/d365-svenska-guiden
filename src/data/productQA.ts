    ...
    items: [
      {
        ...
        answer: `Dynamics 365 Sales finns i tre licensnivåer:\n\nSales Professional: {{price:sales-professional:exact}} – grundläggande CRM med kontakter, konton, leads, opportunities och offerthantering. Passar mindre säljteam som behöver standardfunktionalitet.\n\nSales Enterprise: {{price:sales-enterprise:exact}} – full CRM med avancerad pipeline-styrning, prognoser, anpassningsbara processer, säljspel och Copilot AI inkluderat.\n\nSales Premium: {{price:sales-premium:exact}} – Sales Enterprise plus avancerade AI-funktioner som relationsinsikter, förutsägande lead- och opportunityscoring samt samtalsanalys.\n\nProjektkostnad: Räkna med 200 000–400 000 kr för startpaket (5–15 säljare, 6–10 veckor), 400 000–800 000 kr för medelstor implementation (15–50 säljare, 3–5 månader) och från 800 000 kr för stora globala införanden (50+ säljare, 6–12 månader).`,
      },
      {
    ...
    items: [
      {
        ...
        answer: `Customer Service finns i två huvudsakliga licensnivåer:\n\nCustomer Service Professional: {{price:customer-service-pro:exact}} – grundläggande ärendehantering, kunskapsbas och e-postärenden. Passar mindre supportteam med en eller två kanaler.\n\nCustomer Service Enterprise: {{price:customer-service-enterprise:exact}} – full omnikanal med chatt, sociala medier, samtal, AI-routing, Copilot, anpassade processer och avancerad analys.\n\nContact Center (digitalt tillägg): {{price:contact-center-digitalt:exact}} – lägger till chatt, SMS, WhatsApp, Facebook Messenger m.fl. digitala kanaler.\n\nContact Center (komplett): {{price:contact-center-komplett:exact}} – inbyggd telefoni via Microsoft för helt integrerat callcenter utan separat växellösning.\n\nProjektkostnad: 250 000–500 000 kr för startpaket (5–15 agenter, 6–10 veckor), 500 000–1 000 000 kr för medelstor omnikanal-implementation (15–50 agenter, 3–5 månader) och från 1 000 000 kr för stora callcenter (50+ agenter, 6–12 månader).`,
      },
      {
      ...
      },
      {
        ...
        answer: `Customer Service jämförs oftast med ServiceNow Customer Service Management och Zendesk Suite.\n\nMicrosoft-integration: Dynamics 365 Customer Service ger nativ koppling till Teams, Outlook, SharePoint och Power Platform – agenter och experter samarbetar i samma miljö utan tillägg.\n\nLicenspris: Customer Service Enterprise ({{price:customer-service-enterprise:short}} per agent) är ofta 30–50 % billigare än ServiceNow CSM och i nivå med Zendesk Suite Professional/Enterprise.\n\nAI-funktioner: Copilot ingår i Enterprise utan extra licens – ärendesammanfattning, svarsförslag och kunskapsutkast. ServiceNow Now Assist och Zendesk AI kräver oftast tilläggslicens.\n\nOmnikanal: Voice Channel, Digital Messaging och chatt levereras i samma plattform. Zendesk är starkt på digital messaging men svagare på röst utan tredjepart. ServiceNow är starkast i ITSM-närliggande processer.\n\nCRM-helhet: Tillsammans med Sales, Marketing och Field Service ger Dynamics 365 ett 360-graders kundperspektiv som varken ServiceNow eller Zendesk kan matcha out-of-the-box.`,
      },
      {
