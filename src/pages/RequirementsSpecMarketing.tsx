  ...
  return (
    <>
      <SEOHead
        ...
        description="Skapa en skräddarsydd kravspecifikation för Microsoft Dynamics 365 Customer Insights (Marketing). Anpassad efter din bransch med AI-berikade krav."
