...
import {
  ...
  Globe, Workflow, UserCheck,
} from "lucide-react";

const breadcrumbs = [
  { name: "Hem", url: "https://d365.se" },
  { name: "CRM", url: "https://d365.se/crm" },
  { name: "Kravspecifikation Marketing", url: "https://d365.se/kravspecifikation-marketing" },
];

const areaOptions = [
  { id: "segments", label: "Segment & Målgrupper", icon: Users },
  { id: "journeys", label: "Kundresor & Automation", icon: Workflow },
  { id: "email", label: "E-postkampanjer", icon: Mail },
  { id: "events_mgmt", label: "Event & Webinarier", icon: Globe },
  { id: "forms_pages", label: "Formulär & Landningssidor", icon: MousePointer },
  { id: "lead_scoring", label: "Lead Scoring & Kvalificering", icon: Target },
  { id: "consent", label: "Samtycke & GDPR", icon: UserCheck },
  { id: "analytics", label: "Analys & Attribution", icon: BarChart3 },
  { id: "personalization", label: "Personalisering & AI", icon: Zap },
...
const RequirementsSpecMarketing = () => {
  ...
  useEffect(() => {
    trackFunnelEvent({ event_type: "analysis_start", event_name: "kravspec_marketing" });
  }, []);

  useEffect(() => {
    if (step === totalSteps) {
      trackFunnelEvent({ event_type: "analysis_complete", event_name: "kravspec_marketing" });
    }
  }, [step]);
  ...
  return (
    <>
      <SEOHead
        title="Kravspecifikation för Dynamics 365 Marketing | d365.se"
        description="Skräddarsydd kravspec för Customer Insights (Marketing) – AI-berikade branschanpassade krav. Vi står på köparens sida när du väljer Microsoft Dynamics 365-partner."
...
export default RequirementsSpecMarketing;
