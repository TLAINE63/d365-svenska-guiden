  ...
  return (
    <>
      <SEOHead
        ...
        description="Skräddarsydd kravspec för Customer Insights (Marketing) – AI-berikade branschanpassade krav. Köparsidig vägledning inför val av Dynamics 365 och partner."
