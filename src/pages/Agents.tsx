  ...
  return (
    <div className="min-h-screen">
      <SEOHead 
        ...
        description="AI Agents i Dynamics 365: Sales, Customer Service och Supply Chain – AI-automation för Sverige. Oberoende vägledning inför val av Dynamics 365 och partner."
