  ...
  return (
    <div className="min-h-screen">
      <SEOHead 
        ...
        description="Microsoft AI Agents i Dynamics 365: Sales, Customer Service och Supply Chain Agent. AI-automation för svenska företag. Oberoende vägledning inför val av Dynamics 365 och partner."
      ...
      <ServiceSchema 
        ...
        description="Autonoma AI-agenter i Dynamics 365 som arbetar självständigt för att lösa komplexa affärsuppgifter inom försäljning, kundservice, ekonomi och supply chain. Redo för svenska företag. Oberoende vägledning inför val av Dynamics 365 och partner."
      />
