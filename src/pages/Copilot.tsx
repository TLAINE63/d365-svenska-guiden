...
const Copilot = () => {
  ...
  return (
    <div className="min-h-screen copilot-theme" style={{
      ...
      <SEOHead 
        title="Copilot i Microsoft Dynamics 365 – AI för ERP/CRM"
        description="Copilot i Microsoft Dynamics 365 ingår i licensen. AI för Finance, Sales och Customer Service. Vi står på köparens sida när du väljer Microsoft Dynamics 365-partner."
      ...
      <ServiceSchema 
        ...
        description="Inbyggd AI-assistent i Dynamics 365 utan extra licensavgift. Copilot automatiserar processer i Finance, Supply Chain, Sales, Customer Service och Business Central. 353% potentiell ROI över 3 år enligt Forrester TEI-studie 2024. Vi står på köparens sida när du väljer Microsoft Dynamics 365-partner."
      />
