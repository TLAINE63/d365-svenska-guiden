  ...
  return (
    <div className="min-h-screen">
      ...
      <ShortAnswer title="Vad är Dynamics 365 Commerce">
        Dynamics 365 Commerce är Microsofts omnikanal-plattform för retail och konsument­varor — en lösning som samlar fysisk butik, e-handel, mobil och kundklubb i en gemensam datamodell med en enda produktkatalog, prismotorn och kundprofil. Kärnan är Commerce Scale Unit, en central dataplattform som synkar produkter, priser, lagersaldon och kunddata i realtid över alla kanaler så att butikspersonal, e-handel och kundtjänst alltid ser samma bild. På topp ligger Commerce POS (en modern kassalösning som fungerar både online och offline med automatisk synkronisering), en pris- och kampanjmotor som hanterar miljontals prisuträkningar per dag med stöd för köp-N-betala-M, tröskelrabatter, mix-och-matcha, kundklubbs­priser och affinity-baserade kampanjer, samt Sites Builder för drag-and-drop e-handel eller headless-arkitektur mot React/Next.js-frontends. Lojalitets­programmet hanterar poäng, nivåer och förmåner kopplade till en samlad kundprofil i Dataverse — med Customer Insights kan retail-kedjor bygga personaliserade kampanjer och AI-prediktioner. Commerce är djupt integrerat med Finance & Supply Chain Management för redovisning, inköp, lager och varuförsörjning, vilket gör helhetslösningen särskilt stark för retail-kedjor som vill konsolidera bort separata kassa-, lager- och e-handelssystem — men implementationen är ett betydande åtagande och kräver en partner med dokumenterad retail-erfarenhet.
      </ShortAnswer>
