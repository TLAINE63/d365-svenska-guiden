  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        description="Kostnadsfri behovsanalys för Dynamics 365 Customer Service, Field Service och Contact Center. Vi står på köparens sida när du väljer partner för Microsoft Dynamics 365."
      ...
      />
      <ServiceSchema name="Kundservice Behovsanalys" description="Kostnadsfri behovsanalys för att hitta rätt Dynamics 365 lösning för kundservice och fältservice. Vi står på köparens sida när du väljer partner för Microsoft Dynamics 365." />
