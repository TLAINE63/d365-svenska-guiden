...
const industries: Industry[] = [
 ...
 { name: "Transport & Logistik", slug: "logistik-transport", image: transportLogistikImg, description: "Lösningar för transport och logistik", products: ["bc", "fsc"], partnerIndustries: ["Transport & Logistik"] },
 ...
 { name: "Medlemsorganisationer", slug: "medlemsorganisationer", image: medlemsorganisationerImg, description: "Lösningar för medlemsorganisationer, förbund och föreningar", products: ["bc", "crm-sales", "crm-service"], partnerIndustries: ["Medlemsorganisationer"] },
...
const Branschlosningar = () => {
 ...
 <SEOHead 
 title="Dynamics 365 Branschlösningar – ERP & CRM per bransch | d365.se"
 description="Dynamics 365 per bransch: tillverkning, grossist, bygg, fastighet, handel m.fl. Jämför Business Central, Finance & SCM och CRM – och hitta partner som kan din bransch."
 ...
 description="Katalog över Microsoft-certifierade Dynamics 365-partners med branschspecialisering inom tillverkning, handel, fastighet, bygg, life science och 14 andra branscher. Filtrera på produkt (Business Central, Finance & SCM, CRM) och bransch för att hitta rätt partner. Vi står på köparens sida när du väljer Microsoft Dynamics 365-partner."
 />
 ...
 <Badge key={f} className="bg-primary/40 text-white border-primary/50 py-1.5 px-3 ">
