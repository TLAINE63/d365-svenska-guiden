                ...
                <Button
                  ...
                  className={`transition-all rounded-full px-4 ${
                    selectedIndustry === industry 
                      ? "bg-gradient-to-r from-finance-supply to-finance-supply/80 text-white shadow-lg shadow-finance-supply/25 scale-105" 
                      : "border-finance-supply/30 text-finance-supply hover:bg-finance-supply/10 hover:border-finance-supply/50 hover:scale-105"
                  }`}
                >
                  {industry}
                  {selectedIndustry === industry && (
