  ...
  return (
    <div className="min-h-screen">
      <SEOHead 
        ...
        description="Dynamics 365 Finance & Supply Chain från 2 007 kr/mån. SAP-alternativ för tillverkning. Oberoende vägledning inför val av Dynamics 365 och partner."
