...
const FinanceSupplyChain = () => {
  ...
  return (
    <div className="min-h-screen">
      <SEOHead 
        title="Dynamics 365 Finance & Supply Chain – pris, moduler & partner Sverige"
      ...
      <ShortAnswer title="Vad är Dynamics 365 Finance & Supply Chain">
        Dynamics 365 Finance & Supply Chain Management är Microsofts enterprise-affärssystem för större och internationella organisationer med avancerad ekonomi, supply chain, flera juridiska bolag, flera valutor och hög grad av regelefterlevnad. Plattformen täcker hela värdekedjan: global ekonomistyrning och konsolidering, avancerad tillverkning med MRP/MPS, lager- och warehouse management (WMS), inköp, transportplanering samt finansiell rapportering enligt lokala regelverk i fler än 40 länder. Genom de tillhörande modulerna Dynamics 365 Commerce kan ni dessutom hantera omnikanal-handel med integrerad POS, e-handel och clienteling för retail- och B2B-verksamheter; Dynamics 365 Human Resources ger stöd för medarbetarregister, kompetens och organisationsstruktur i större bolag; och Dynamics 365 Project Operations binder ihop projektförsäljning, resursplanering, tidrapportering och projektredovisning i samma plattform. Inbyggd Copilot och autonoma agenter automatiserar repetitiva flöden — från leverantörsavstämning och prognoser till kund- och projektkommunikation — och hela sviten bygger på Microsofts moln med Power Platform, Fabric och Azure i botten, vilket gör F&SCM till ett tryggt val för organisationer med höga krav på skalbarhet, integration och styrning.
      </ShortAnswer>
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-background">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-4xl mx-auto">
            <div className="rounded-2xl border border-border bg-card p-6 sm:p-10 shadow-[var(--shadow-card)]">
