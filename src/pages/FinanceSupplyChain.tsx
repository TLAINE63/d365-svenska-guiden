  ...
  return (
    <div className="min-h-screen">
      <SEOHead 
        ...
        description="Dynamics 365 Finance & Supply Chain från 2 007 kr/mån. SAP-alternativ för tillverkning. Köparsidig vägledning inför val av Dynamics 365 och partner."
      ...
      <ServiceSchema 
        ...
        description="Enterprise ERP-lösning för global ekonomihantering, supply chain, tillverkning och distribution. Licenspris från 2 007,30 kr per användare och månad. SAP-alternativ med inbyggd Copilot AI. Implementationstid 9–36 månader beroende på komplexitet. Köparsidig vägledning inför val av Dynamics 365 och partner."
      />
