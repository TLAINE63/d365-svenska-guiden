...
const Events = () => {
    ...
    return (
      <div className="min-h-screen bg-background">
        <SEOHead
          ...
          description="Kommande webinars och events från Dynamics 365-partners i Sverige: BC, Sales, AI och Copilot. Köparsidig vägledning inför val av Dynamics 365 och partner."
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        title="Dynamics 365 Events & Webinars Sverige | d365.se"
        description="Kalender med webinars och seminarier från Dynamics 365-partners – BC, Sales, AI och Copilot. Köparsidig vägledning inför val av Dynamics 365 och partner."
        canonicalPath="/events"
        keywords="Dynamics 365 event Sverige, Microsoft Dynamics 365 webinar, Business Central seminarium, Dynamics 365 partner event, Microsoft ERP webinar Sverige, Copilot event"
        ogImage="https://d365.se/og-events.png"
      />
