  ...
  return (
    <div className="min-h-screen">
      ...
      <ShortAnswer title="Vad är Dynamics 365 Project Operations">
        Dynamics 365 Project Operations är Microsofts samlade projektmodul för konsult-, ingenjörs- och tjänsteföretag — en plattform som binder ihop sälj, leverans och ekonomi i ett enda flöde från första offert till slutfaktura. Här kvalificeras affären i Dynamics 365 Sales, planeras med resurskapacitet och kompetensmatchning, levereras genom uppgifter, tidrapporter och utlägg i Teams och mobilen, och faktureras via fast pris, löpande räkning eller milstolpar med full koppling till projektekonomi, work-in-progress och intäktsavräkning. Inbyggda funktioner för portföljstyrning, prognos, marginal­uppföljning per projekt och utilization av konsulter ger ledningen realtidsbild av lönsamheten — medan Copilot och AI-agenter hjälper projektledare att sammanfatta statusrapporter, identifiera risk och föreslå nästa åtgärd. Project Operations är fristående men blomstrar när det integreras djupt med Finance & Supply Chain Management eller Business Central för redovisning, Sales för CRM och Customer Service för support efter projektet — och precis som med övriga D365-appar avgör partnerns förmåga att modellera er specifika leveransmodell hur stor effekten faktiskt blir.
      </ShortAnswer>
