  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      <Helmet>
        ...
        <meta name="description" content="Ställ en fri fråga om Microsoft Dynamics 365, Copilot, AI-agenter eller hur du hittar rätt partner. Oberoende, neutral AI-assistent." />
