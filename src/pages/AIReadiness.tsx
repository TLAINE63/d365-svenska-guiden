            ...
            {step === "foundation" && (
              <>
                <div className="mb-6 flex items-center gap-2">
                  ...
                  <span className="text-sm font-semibold text-[hsl(var(--hero-dark))] uppercase tracking-wide">
            ...
            {step === "role_select" && (
              <>
                <div className="mb-6 flex items-center gap-2">
                  ...
                  <span className="text-sm font-semibold text-[hsl(var(--hero-dark))] uppercase tracking-wide">Steg 2 – Välj roll</span>
                </div>
                    ...
                    return (
                      <button key={t.id} onClick={() => handleRoleSelect(t.id)}
                        className={`w-full text-left rounded-lg border-2 px-5 py-4 transition-all duration-200 flex items-center gap-4 ${
                          selectedRole === t.id ? "border-[hsl(var(--hero-dark))] bg-[hsl(var(--hero-dark))]/10 ring-2 ring-[hsl(var(--hero-dark))]/30" : "border-border bg-card hover:bg-muted/50 hover:border-[hsl(var(--hero-dark))]/30"
                        }`}>
