  ...
  return (
    <div className="min-h-screen">
      <SEOHead 
        ...
        description="Dynamics 365 Sales från 621 kr/mån med Copilot AI. Jämför mot Salesforce. Köparsidig vägledning inför val av Dynamics 365 och partner."
      ...
      <ServiceSchema 
        ...
        description="Molnbaserat CRM-system för moderna säljteam med inbyggd Copilot AI, förutsägande leadpoängsättning och sömlös Microsoft 365-integration. Licenspriser från 621 kr/användare/mån. Köparsidig vägledning inför val av Dynamics 365 och partner."
      />
