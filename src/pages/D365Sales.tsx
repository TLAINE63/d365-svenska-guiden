  ...
  return (
    <div className="min-h-screen">
      <SEOHead 
        ...
        description="Guide till Microsoft Dynamics 365 Sales – det ledande Microsoft CRM-systemet för säljteam. Priser från 621 kr/mån, Copilot AI inbyggt, och jämförelse mot Salesforce. Hitta certifierad partner i Sverige."
      ...
      <ServiceSchema 
        ...
        description="Molnbaserat CRM-system för moderna säljteam med inbyggd Copilot AI, förutsägande leadpoängsättning och sömlös Microsoft 365-integration. Licenspriser från 621 kr/användare/mån."
      />
