        ...
        <section className="py-12 sm:py-16 bg-gradient-to-br from-secondary/60 to-background">
          <div className="container mx-auto px-4 sm:px-6 max-w-5xl">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-foreground mb-4">
              Dynamics 365 prislista
            </h1>
            <p className="text-base sm:text-lg text-muted-foreground">
              Microsofts officiella listpriser för Dynamics 365 (SEK exkl. moms).
              Faktiskt pris kan variera beroende på avtal (EA, CSP), volym och kampanjer.
            </p>
          </div>
        </section>
