                  ...
                  {Array.from({ length: TOTAL_STEPS }).map((_, i) => (
                    <div
                      ...
                      className={`w-2.5 h-2.5 rounded transition-colors ${
                        i + 1 === step ? "bg-[hsl(var(--hero-dark))]" : i + 1 < step ? "bg-[hsl(var(--hero-dark))]/50" : "bg-border"
                      }`}
                    />
                  ))}
                </div>
                      ...
                      return (
                        <button
                          ...
                          className={`relative group rounded-lg overflow-hidden border-2 transition-all aspect-[5/4] ${
                            isSelected
                              ? "border-[hsl(var(--hero-dark))] ring-2 ring-[hsl(var(--hero-dark))]/30 scale-[1.02]"
                              : "border-border hover:border-[hsl(var(--hero-dark))]/40"
                          }`}
                        >
                          {img && (
                            <img
                          ...
                          <div className={`absolute inset-0 transition-colors ${
                            isSelected ? "bg-[hsl(var(--hero-dark))]/40" : "bg-black/45 group-hover:bg-black/35"
                          }`} />
                          {isSelected && (
                            <div className="absolute top-1 right-1 w-5 h-5 rounded bg-[hsl(var(--hero-dark))] flex items-center justify-center">
                    ...
                    return (
                      <button
                        ...
                        className={`flex flex-col items-center justify-center text-center px-3 py-4 rounded-lg border-2 transition-all ${
                          isSelected
                            ? "border-[hsl(var(--hero-dark))] bg-[hsl(var(--hero-dark))]/5 "
                            : "border-border bg-card hover:border-[hsl(var(--hero-dark))]/40"
                        }`}
                      >
                        {opt.icon ? (
                        ...
                        {isSelected && (
                          <div className="absolute top-1.5 right-1.5 w-5 h-5 rounded bg-[hsl(var(--hero-dark))] flex items-center justify-center">
                            <Check className="h-3 w-3 text-white" />
                          </div>
                        )}
                      </button>
