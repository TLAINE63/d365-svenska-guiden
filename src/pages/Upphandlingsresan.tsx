...
const Upphandlingsresan = () => {
 ...
 />
 <Navbar />
 <main className="min-h-screen bg-secondary/30 pt-16 lg:pt-28">
 <BuyerJourneyStages />

 {/* Steg 1: Kravspecifikation */}
 <section className="section-divider section-divider-dark bg-[hsl(var(--hero-dark))] py-14 sm:py-20 relative overflow-hidden border-b border-white/10">
