...
import {
  ...
  Wrench, MessageSquare, Settings, ClipboardList, Globe,
} from "lucide-react";
...
const areaOptions = [
  { id: "case_mgmt", label: "Ärendehantering", icon: ClipboardList },
  { id: "queues_routing", label: "Köer & Routing", icon: Users },
  { id: "knowledge", label: "Kunskapsbas & FAQ", icon: FileText },
  { id: "sla_entitlements", label: "SLA & Serviceavtal", icon: Settings },
  { id: "channels", label: "Kanaler (Chatt, E-post, Telefon)", icon: MessageSquare },
  { id: "contact_center", label: "Contact Center & Telefoni", icon: Phone },
  { id: "copilot_ai", label: "Copilot & AI-assistans", icon: Zap },
  { id: "field_service", label: "Fältservice & Arbetsorder", icon: Wrench },
  { id: "scheduling", label: "Schemaläggning & Resurser", icon: Headphones },
  { id: "analytics_cs", label: "Analys & Rapportering", icon: BarChart3 },
  { id: "self_service", label: "Självbetjäningsportal", icon: Globe },
  { id: "integration_cs", label: "Integrationer", icon: Link2 },
];
...
const RequirementsSpecCustomerService = () => {
  ...
  const [selectedAreas, setSelectedAreas] = useState<string[]>([
    "case_mgmt", "queues_routing", "knowledge", "sla_entitlements", "channels", "analytics_cs", "integration_cs",
  ]);
  ...
  const handleGenerate = async () => {
    ...
    try {
      const { data, error } = await supabase.functions.invoke("generate-requirements", {
        body: { product: "customer_service", industry, companySize, areas: selectedAreas },
      });
  ...
  return (
    <>
      <SEOHead
        ...
        description="Skapa en skräddarsydd kravspecifikation för Dynamics 365 Customer Service, Contact Center och Field Service. AI-berikad med branschspecifika krav."
          ...
          {step === 1 && (
            <div className="space-y-6">
              ...
              <p className="text-sm text-muted-foreground">
                Branschen påverkar vilka specialkrav och KPI:er som inkluderas i din kundservicekravspecifikation.
              </p>
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    <div>
                      <h2 className="text-xl font-semibold text-foreground mb-1">
                        Kravspecifikation – Dynamics 365 Kundservice
                      </h2>
                      <p className="text-sm text-muted-foreground">
...
export default RequirementsSpecCustomerService;
