  ...
  return (
    <>
      <SEOHead
        ...
        description="Skräddarsydd kravspec för Customer Service, Contact Center och Field Service – AI-berikad. Vi står på köparens sida när du väljer partner för Microsoft Dynamics 365."
