  ...
  return (
    <div className="min-h-screen">
      <SEOHead 
        ...
        description="Business Central: Essentials 765 kr/mån, Premium 1 051 kr/mån. Köparsidig vägledning inför val av Dynamics 365 och partner."
      ...
      <ServiceSchema 
        ...
        description="Molnbaserat ERP-system för mindre och medelstora företag. Inkluderar ekonomi, lager, försäljning, inköp och produktion med inbyggd Microsoft Copilot AI. Köparsidig vägledning inför val av Dynamics 365 och partner."
      />
