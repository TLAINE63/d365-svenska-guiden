  ...
  return (
    <div className="min-h-screen">
      <SEOHead
        ...
        description="Affärssystem 2026: vad det är, vad det kostar och hur du väljer rätt på den svenska marknaden. Köparsidig vägledning inför val av Dynamics 365 och partner."
      ...
      <ServiceSchema
        ...
        description="Oberoende guide till affärssystem i Sverige. Förklarar vad ett affärssystem är, hur du väljer rätt och vilka alternativ som finns på marknaden. Köparsidig vägledning inför val av Dynamics 365 och partner."
      />
