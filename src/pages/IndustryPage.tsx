...
const IndustryPage = ({ initialPartners }: IndustryPageProps = {}) => {
 ...
 <Link to="/valjdynamics365partner" className="text-primary hover:underline">Hitta rätt partner →</Link>
 ...
 <section id="partners" className="scroll-mt-24 py-12 border-b border-border bg-muted/20">
