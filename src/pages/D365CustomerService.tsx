  ...
  return (
    <div className="min-h-screen">
      <SEOHead 
        ...
        description="Dynamics 365 Customer Service från 478 kr/mån. Helpdesk med Copilot AI och omnikanal. Köparsidig vägledning inför val av Dynamics 365 och partner."
      ...
      <ServiceSchema 
        ...
        description="Molnbaserat kundservicesystem och helpdesk med inbyggd Copilot AI, omnikanalstöd (e-post, chatt, telefon, SMS) och självbetjäningsportaler. Licenspriser från 478 kr/kundservicemedarbetare/mån. Köparsidig vägledning inför val av Dynamics 365 och partner."
      />
