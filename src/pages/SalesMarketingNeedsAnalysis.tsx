...
const SalesMarketingNeedsAnalysis = () => {
 ...
 isActive ? 'bg-[hsl(var(--hero-dark))] text-white' : 
 isCompleted ? 'bg-[hsl(var(--hero-dark))]/20 text-[hsl(var(--hero-dark))]' : 
 'bg-muted text-muted-foreground'
 }`}>
 <Icon className="w-5 h-5" />
 </div>
 <span className={`text-[10px] leading-tight text-center ${isActive ? 'text-[hsl(var(--hero-dark))] font-medium' : 'text-muted-foreground'}`}>
 {title}
 </span>
 </button>
 );
 ...
 <Card className="">
 <CardHeader className="bg-gradient-to-r from-[hsl(var(--hero-dark))]/10 to-[hsl(var(--hero-dark))]/5 border-b py-3">
 <div className="flex items-center gap-2">
 <StepIcon className="w-5 h-5 text-[hsl(var(--hero-dark))]" />
 <CardTitle className="text-lg text-[hsl(var(--hero-dark))]">
