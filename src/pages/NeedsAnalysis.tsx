...
Finance & Supply Chain passar organisationer med höga krav på funktionalitet, global närvaro och komplexa affärsprocesser.`;
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      <SEOHead 
        title="Behovsanalys ERP – få rekommendation Business Central eller F&SCM"
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-1 px-3 py-1.5 rounded text-xs font-medium transition-all ${
                    isActive
                      ? "bg-[hsl(var(--hero-dark))] text-white"
                      : isCompleted
                      ? "bg-[hsl(var(--hero-dark))]/20 text-[hsl(var(--hero-dark))]"
            ...
            <CardHeader className="py-3">
              <CardTitle className="flex items-center gap-2 text-lg">
                {(() => {
                  ...
                  return <Icon className="w-5 h-5 text-[hsl(var(--hero-dark))]" />;
                })()}
