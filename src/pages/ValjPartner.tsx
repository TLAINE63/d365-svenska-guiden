  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead 
        ...
        description="Jämför certifierade Dynamics 365-partners. Filtrera på bransch, applikation och geografi. Köparsidig vägledning inför val av Dynamics 365 och partner."
      ...
      <ServiceSchema 
        ...
        description="Hjälp att välja rätt Microsoft Dynamics 365 implementeringspartner baserat på bransch, storlek och behov. Köparsidig vägledning inför val av Dynamics 365 och partner."
      />
