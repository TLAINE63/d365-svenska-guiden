  ...
  return (
    <>
      <SEOHead
        ...
        description="Systemoberoende ERP-kravspec: branschanpassade AI-berikade krav, KPI:er och rekommendation. Vi står på köparens sida när du väljer partner för Microsoft Dynamics 365."
