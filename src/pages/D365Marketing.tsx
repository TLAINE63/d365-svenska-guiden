  ...
  return (
    <div className="min-h-screen">
      ...
      <ShortAnswer title="Vad är Dynamics 365 Customer Insights">
        Dynamics 365 Customer Insights är Microsofts moderna marknads- och kunddataplattform och består av två tätt integrerade delar: Customer Insights — Data, en kraftfull Customer Data Platform (CDP) som samlar och förenar kunddata från CRM, ERP, webb, e-handel, lojalitetsprogram och tredjepartskällor till en gemensam, AI-berikad kundprofil med segment, livstidsvärde och nästa-bästa-åtgärd; och Customer Insights — Journeys, en automationsmotor för marknadsföring som orkestrerar personaliserade kundresor i realtid över e-post, SMS, push, Teams, webb och annonskanaler. Plattformen vänder sig till både B2B- och B2C-organisationer som vill gå från spridda utskick och magkänsla till datadriven marknadsföring där rätt budskap når rätt person i rätt kanal vid rätt tillfälle. Inbyggd Copilot och autonoma marknadsagenter låter marknadsförare beskriva ett segment eller en kampanj i klartext och få färdiga målgrupper, ämnesrader, innehåll och kundresor genererade på sekunder. Genom djup integration med Dynamics 365 Sales, Customer Service, Dataverse, Fabric och Microsoft 365 ser sälj, marknad och service samma kundbild — men datamodell, källsystem och integrationer som partnern sätter upp är det som faktiskt avgör om plattformen blir en sann tillväxtmotor eller bara ännu ett verktyg.
      </ShortAnswer>
