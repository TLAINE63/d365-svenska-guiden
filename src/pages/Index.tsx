 ...
 */}
 ...
 icon: <ClipboardCheck className="w-5 h-5 text-white" />,
  ...
  desc: "Rätt partner beror på bransch, komplexitet och erfarenhet samt leveransförmåga. Jämför Microsoft-partners här genom branschfiltret.",
 ...
 Lär dig mer
  ...
  <h2 className="text-2xl sm:text-3xl font-bold text-foreground mb-3 tracking-tight sm:whitespace-nowrap">
...
export default Index;  {/* Hur redo är ni för Dynamics 365? — eget framträdande block */}
  <section className="section-divider bg-[hsl(var(--hero-dark))]">
   <div className="container mx-auto px-4 sm:px-6 max-w-6xl">
    <div className="relative rounded overflow-hidden border border-[hsl(var(--line-dark))] bg-[#211F1A]">
     {/* Signaturstreck */}
     <div className="absolute left-0 top-0 bottom-0 w-1 bg-[hsl(var(--signature))]" />
