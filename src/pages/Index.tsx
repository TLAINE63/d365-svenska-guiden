              ...
              {[
                {
                  ...
                  answer: "Hur lång tid en implementation av Microsoft Dynamics 365 tar beror i väldigt hög grad på omfattningen, företagets storlek, hur mycket anpassning och integration som krävs – men här kommer en ungefärlig översikt och vad du bör räkna med.\n\nTidsramar\nFör ett relativt enkelt upplägg i ett mindre företag: ca 3-6 månader.\nFör medelstor organisation med måttlig komplexitet: ofta 6-12 månader. För stora företag med många länder, många system att integrera och hög grad av anpassning: 9-24 månader eller mer.\nI vissa fall där krav är mycket begripliga och standardlösning räcker kan man snabbt komma igång – t.ex. \"rapid activation\" modell: 2-12 veckor för ett mycket smalt scope.\n\nVad påverkar hur lång tid det tar?\nHär är några av de viktigaste faktorerna:\n\nProjektets omfattning (scope) – Vilka moduler i Dynamics 365 ska användas (CRM, ERP, försäljning, service, marketing etc), hur många affärsprocesser ska stödjas? Anpassning och integration – Ju mer specialanpassningar, ju fler externa system som ska kopplas ihop, desto längre tid.\nDatamigrering – Hur mycket data, hur många system, hur komplex datakvaliteten är. Dagra migrering kan dra ut projektet. Resurser och organisation – Tillgängliga medarbetare, interna beslut, förändringsledning, utbildning, användaracceptans spelar stor roll. Metodik och partnerkompetens – Om du har erfaren partner och standardprocesser kan det gå snabbare; om du bygger mycket från grunden tar det längre. Efterarbete och förändringsarbete (change management) – Att få användarna att använda systemet fullt ut, och att processen fortsätter efter go-live",
                },
                {
