...
const Index = () => {
  return <div className="min-h-screen bg-background">
      ...
      <NoscriptSEO
        ...
        description="d365.se är Sveriges oberoende guide till Microsoft Dynamics 365. Vi hjälper svenska företag att jämföra ERP- och CRM-lösningar, hitta rätt Microsoft-certifierad partner och göra kostnadsfria behovsanalyser. Business Central från 884 kr per användare och månad."
        sections={[
          ...
          { heading: "Dynamics 365 Business Central – pris och licenser i Sverige", text: "Dynamics 365 Business Central kostar från 884 kr per användare och månad med Essentials-licens, eller 1 255 kr per månad med Premium-licens som inkluderar produktion och servicehantering. Teammedlemmar med begränsad åtkomst kostar från cirka 70 kr per månad. Utöver licenserna tillkommer implementeringskostnader – räkna med 300 000 till 1 500 000 kr för en fullständig implementation beroende på komplexitet, antal användare och anpassningsbehov. Business Central passar företag med cirka 10 till 300 anställda som behöver ett komplett affärssystem för ekonomi, order, lager, inköp, produktion och projekt." },
