...
const Index = () => {
  ...
  const matchSteps = [
    { n: 1, icon: Building2, title: "Välj bransch", desc: "Tillverkning, retail, tjänster, life science m.fl." },
    { n: 2, icon: Layers, title: "Välj lösning", desc: "ERP, CRM eller en specifik Dynamics 365-app." },
    { n: 3, icon: Users, title: "Ange storlek", desc: "Antal anställda och omsättning." },
          ...
          <div className="container mx-auto px-4 sm:px-6 max-w-6xl">
            <div className="max-w-2xl mb-10 sm:mb-12">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-[34px] font-bold text-foreground tracking-tight mb-3 leading-tight">
                Så hittar ni rätt partner
              </h2>
              <p className="text-[15px] sm:text-base text-muted-foreground leading-relaxed">
                Fyra filter — inget mer som ska in. Matchningen bygger på relevans, inte sponsring.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <p className="text-[13px] text-muted-foreground">
                Kostnadsfritt · Ingen registrering · Matchningen bygger på relevans, inte sponsring.
              </p>
            </div>
          </div>
        </section>
