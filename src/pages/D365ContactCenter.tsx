  ...
  return (
    <div className="min-h-screen">
      <SEOHead 
        ...
        description="Dynamics 365 Contact Center från 1 051 kr/agent/mån. AI-agenter, routing och omnichannel. Vi står på köparens sida när du väljer partner för Microsoft Dynamics 365."
      ...
      <ServiceSchema 
        ...
        description="Molnbaserat contact center med omnichannel-stöd (telefon, chatt, e-post, SMS, sociala medier), AI-drivna virtuella agenter och intelligent routing. Licenspris från 1 051 kr per agent och månad. Implementationstid 2–12 månader. Vi står på köparens sida när du väljer partner för Microsoft Dynamics 365."
      />
