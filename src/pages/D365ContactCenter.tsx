  ...
  return (
    <div className="min-h-screen">
      <SEOHead 
        ...
        description="Dynamics 365 Contact Center från 1 051 kr/agent/mån. AI-agenter, routing och omnichannel. Vi står på köparens sida när du väljer Microsoft Dynamics 365-partner."
