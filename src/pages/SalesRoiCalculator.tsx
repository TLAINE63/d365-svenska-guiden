            ...
            {showAssumptions && (
              <div className="mt-6 space-y-4 text-sm text-foreground/90">
                ...
                <Assumption title="Implementation">
                  Bas: Låg 100 000 kr, Medel 350 000 kr, Hög 750 000 kr. Skalas mjukt med antal säljare (+1,5 % per säljare över 15)
