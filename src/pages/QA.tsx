...
const QA = () => {
  ...
  const faqs = [
    ...
    {
      id: "bast",
      question: "Varför är Microsoft Dynamics 365 bäst i klassen?",
      answer: "Dynamics 365 placeras år efter år som ledare i Gartners Magic Quadrant och Forrester Wave för både CRM och ERP. Det som gör plattformen branschledande:\n\n**Copilot inbyggt utan extra licens**\n\nMötessammanfattningar, e-postutkast, ärendesammanfattningar, kunskapsartikelutkast och leadscoring ingår i flera Enterprise-licenser. Konkurrenter tar oftast extra betalt för motsvarande AI.\n\n**En sammanhängande plattform**\n\nSales, Customer Service, Field Service, Marketing, Business Central och Finance & Supply Chain delar samma datamodell (Dataverse). Ett kundkort, ett affärsflöde – från första kontakt till betald faktura.\n\n**Djupaste Microsoft 365-integrationen på marknaden**\n\nOutlook, Teams, Excel, SharePoint och Power BI fungerar nativt. Inga tredjepartskonnektorer för basscenarier.\n\n**Power Platform**\n\nBygg appar, automatiseringar och AI-agenter utan kod – sänker totalkostnad och accelererar förändring.\n\n**Global skala och säkerhet**\n\nMicrosoft Cloud med EU-datacenter, GDPR-efterlevnad, ISO 27001 och stöd för reglerade branscher gör plattformen trygg även för finans, vård och offentlig sektor.",
    },
  ];
  ...
  return (
    <div className="min-h-screen">
      <SEOHead
        ...
        description="Svar på vanliga frågor om Dynamics 365: implementeringstid, licenskostnader, Business Central vs Finance och CRM-val. Oberoende vägledning inför val av Dynamics 365 och partner."
        canonicalPath="/qa"
