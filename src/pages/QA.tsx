...
const QA = () => {
  ...
  const faqs = [
    ...
    {
      id: "nar-starkt-val",
      question: "När är Dynamics 365 ett starkt val?",
    ...
    {
      id: "nar-inte-ratt",
      question: "När är Dynamics 365 inte rätt val?",
