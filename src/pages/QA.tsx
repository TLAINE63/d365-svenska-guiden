...
const QA = () => {
  const faqs = [
    {
      id: "fordelar",
      question: "Vad är de verkliga fördelarna med Microsoft Dynamics 365?",
      answer: "Microsoft Dynamics 365 erbjuder flera konkreta fördelar som kan transformera hur din organisation arbetar:\n\n🎯 **Affärskritiska fördelar**\n\n**Allt i molnet** – Ingen egen serverhantering, automatiska uppdateringar och säkerhetspatchar. Tillgång var som helst, när som helst.\n\n**En plattform för allt** – Alla applikationer (Sales, Service, Finance, Supply Chain, Marketing) delar samma databas och integrerar sömlöst. Ingen dubbelföring av data mellan system.\n\n**Kraftfull AI med Copilot** – Inbyggd AI som hjälper till med allt från att sammanfatta kundinformation till att föreslå nästa bästa åtgärd. Många AI-funktioner ingår i licensen.\n\n**Microsoft-ekosystemet** – Djup integration med verktyg ni redan använder: Teams, Outlook, Excel, Word, Power BI. Användarna slipper växla mellan system.\n\n**Skalbar och flexibel** – Börja smått och väx. Lägg till fler applikationer och användare i takt med att behoven ökar. Passa både 10 och 10,000 användare.\n\n**Säkerhet i världsklass** – Microsoft investerar miljarder i säkerhet. Certifierad enligt ISO 27001, GDPR-kompatibel, och geografisk datalagringsval.\n\n💡 **Praktiska fördelar för användare**\n\n**Mobilitet** – Fullständiga mobilappar för iOS och Android. Jobba lika effektivt från kontoret, hemmet eller i fält.\n\n**Lägre totalkostnad** – Ingen hårdvara att köpa, färre konsulter att underhålla integrations-spagetti, snabbare implementering än traditionella system.\n\n**Ingen teknisk skuld** – Alltid senaste versionen, inga dyra uppgraderingar vart tredje år. Microsoft släpper nya funktioner löpande.\n\n**Moderna gränssnitt** – Användarvänliga, intuitiva gränssnitt som användarna faktiskt vill använda. Mindre utbildningsbehov.\n\n✅ **Vem passar det för?**\n\nSmå företag som vill växa utan att byta system, medelstora företag som behöver professionell infrastruktur, och stora företag som kräver global skalbarhet. Microsoft Dynamics 365 passar alla som vill modernisera sin affärsverksamhet.",
    },
    {
      id: "implementering",
    ...
    {
      id: "bc-vs-fsc",
      question: "Passar Business Central eller Finance & Supply Chain bäst?",
