  ...
  return (
    <div className="min-h-screen">
      <SEOHead
        ...
        description="Vanliga frågor om Dynamics 365: tid, licenskostnader, BC vs Finance och CRM-val. Vi står på köparens sida när du väljer partner för Microsoft Dynamics 365."
        canonicalPath="/qa"
