  ...
  return (
    <div className="min-h-screen">
      <SEOHead 
        ...
        description="Dynamics 365 Sales från 621 kr/mån, Customer Service från 478 kr/mån. Jämför mot Salesforce – köparsidig vägledning vid val av Microsoft-partner."
        canonicalPath="/crm"
