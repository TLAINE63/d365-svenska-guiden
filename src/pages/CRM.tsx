  ...
  return (
    <div className="min-h-screen">
      <SEOHead 
        ...
        description="Dynamics 365 Sales från 550 kr/mån, Customer Service från 660 kr/mån. Jämför Microsoft CRM vs Salesforce & HubSpot. Oberoende vägledning inför val av Dynamics 365 och partner."
        canonicalPath="/crm"
