  ...
  return (
    <div className="min-h-screen">
      <SEOHead 
        ...
        description="Dynamics 365 Sales från 550 kr/mån, Customer Service från 660 kr/mån. Jämför mot Salesforce. Vi står på köparens sida när du väljer partner för Microsoft Dynamics 365."
        canonicalPath="/crm"
      ...
      <ServiceSchema 
        ...
        description="Molnbaserade CRM-applikationer för försäljning, marknadsföring, kundservice och fältservice med inbyggd AI via Microsoft Copilot. Vi står på köparens sida när du väljer partner för Microsoft Dynamics 365."
      />
