...
const ContactUs = () => {
  return (
    <div className="min-h-screen">
      <SEOHead 
        title="Kontakt – Köparsidig vägledning inför val av Dynamics 365 och partner | d365.se"
        description="Köparsidig vägledning inför val av Dynamics 365 och partner. Boka kostnadsfritt möte med Thomas Laine eller Michael Uhman för rådgivning utan säljpåverkan."
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="max-w-3xl">
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-3 sm:mb-4">
                Köparsidig vägledning inför val av Dynamics 365 och partner
              </h1>
