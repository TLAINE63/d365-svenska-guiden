...
const fieldServiceFaqsRaw = [
  { question: "Vad är fältservice?", answer: "Fältservice (field service) är det arbete som utförs ute hos kund i stället för på kontoret: installation, förebyggande underhåll, felavhjälpning, besiktning och reparation. Begreppet omfattar hela kedjan från att ett servicebehov uppstår, via planering och tilldelning av tekniker, till arbetsorder, reservdelar, tidrapport och fakturering. Dynamics 365 Field Service är Microsofts system för att styra det arbetet – med schemaläggning, mobilapp för tekniker, avtals- och garantihantering samt IoT-baserat underhåll." },
