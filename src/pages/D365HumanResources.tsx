...
const D365HumanResources = () => {
  ...
  return (
    <div className="min-h-screen">
      <SEOHead
        title="Dynamics 365 Human Resources – HR-system för moderna organisationer"
      ...
      <ShortAnswer title="Vad är Dynamics 365 Human Resources">
        Dynamics 365 Human Resources är Microsofts HR-plattform för att hantera medarbetardata, organisations­struktur, anställningsavtal, kompensation, förmåner, frånvaro, prestations­utvärdering och kompetensutveckling i en samlad lösning. Funktionellt täcker den hela medarbetar­livscykeln — onboarding, befordringar, lönerevisioner, certifieringar, successions­planering och offboarding — och ger HR-avdelningen ett strukturerat sätt att förvalta organisations­hierarkier, befattningar och positions­budgetar över flera bolag och länder. Plattformen är nu integrerad som en del av Dynamics 365 Finance & Supply Chain Management, vilket gör att medarbetar­data flödar sömlöst till projektresursplanering (Project Operations), produktionsplanering, ekonomi och rapportering i Power BI. Självservice för chefer och medarbetare sker i Microsoft Teams och Outlook där Copilot kan hjälpa till med vanliga HR-frågor, sammanställningar och beslutsstöd. För svenska organisationer kompletteras lösningen oftast med externa lönesystem (Hogia, Visma, Agda) och rekryteringsverktyg via öppna API:er — och en partner som förstår både svensk arbetsrätt och Microsofts integrationer är avgörande för att helheten ska sitta.
      </ShortAnswer>
