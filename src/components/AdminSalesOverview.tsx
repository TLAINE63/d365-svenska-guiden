...
const PAGE_LABELS: Record<string, string> = {
  ...
  "/d365customerservice": "Dynamics 365 Customer Service",
  ...
  "/CRMbehovsanalys": "Behovsanalys Sälj & Marknad",
  ...
  "/kravspecifikation-kundservice": "Kravspecifikation Customer Service",
...
const ANALYSIS_PAGES = [
  ...
  { path: "/CRMbehovsanalys", label: "Behovsanalys Sälj & Marknad" },
  { path: "/kundservice-behovsanalys", label: "Behovsanalys Kundservice" },
  { path: "/kravspecifikation", label: "Kravspecifikation ERP" },
  { path: "/kravspecifikation-sales", label: "Kravspecifikation Sales" },
  { path: "/kravspecifikation-kundservice", label: "Kravspecifikation Customer Service" },
