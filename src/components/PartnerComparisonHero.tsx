    ...
    <div className="relative w-full h-full flex items-center justify-center">
      ...
      <div className="relative">
        <img
          ...
          className="max-h-[350px] sm:max-h-[400px] md:max-h-[450px] w-auto object-contain rounded-lg"
        />
        
        {/* Floating offer bubbles */}
        <div className="absolute -top-2 -left-4 sm:-left-8 md:-left-16 bg-white rounded  p-3 sm:p-4 animate-fade-in border border-gray-100 min-w-[130px] sm:min-w-[150px]">
          ...
          <div className="flex items-center gap-2">
            <div className="w-5 h-5 sm:w-6 sm:h-6 bg-emerald-500 rounded flex items-center justify-center text-white text-xs font-bold">X</div>
        ...
        <div className="absolute -top-6 sm:-top-8 right-0 sm:right-4 md:right-0 bg-white rounded  p-3 sm:p-4 animate-fade-in border border-gray-100 min-w-[130px] sm:min-w-[150px]" style={{ animationDelay: "0.2s" }}>
          ...
          <div className="flex items-center gap-2">
            <div className="w-5 h-5 sm:w-6 sm:h-6 bg-blue-500 rounded flex items-center justify-center text-white text-xs font-bold">Y</div>
        ...
        <div className="absolute bottom-4 sm:bottom-8 -right-2 sm:-right-4 md:-right-12 bg-white rounded  p-3 sm:p-4 animate-fade-in border border-gray-100 min-w-[130px] sm:min-w-[150px]" style={{ animationDelay: "0.4s" }}>
          ...
          <div className="flex items-center gap-2">
            <div className="w-5 h-5 sm:w-6 sm:h-6 bg-amber-500 rounded flex items-center justify-center text-white text-xs font-bold">Z</div>
