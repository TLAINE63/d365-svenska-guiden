    ...
    <Card className="bg-gradient-to-r from-primary/10 via-primary/5 to-accent/10 border-primary/30 p-4 sm:p-6 relative overflow-hidden rounded-2xl shadow-lg shadow-primary/10">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 relative">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto mt-2 sm:mt-0">
          ...
          />
          <Button type="submit" disabled={isSubmitting} className="whitespace-nowrap bg-emerald-600 hover:bg-emerald-700 text-white animate-shadow-pulse hover:animate-none">
            {isSubmitting ? (
              "Skickar..."
            ) : (
              <>
