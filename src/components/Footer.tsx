        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-x-8 gap-y-8 items-start mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/d365projectoperations/" className="text-muted-foreground hover:text-foreground transition-colors">Dynamics 365 Project Operations</Link></li>
              <li><Link to="/d365commerce/" className="text-muted-foreground hover:text-foreground transition-colors">Dynamics 365 Commerce</Link></li>
              <li><Link to="/d365humanresources/" className="text-muted-foreground hover:text-foreground transition-colors">Dynamics 365 Human Resources</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link to="/kunskapscenter/" className="text-muted-foreground hover:text-foreground transition-colors">Kunskapscenter (Q&A & fördjupningar)</Link></li>
              <li><Link to="/events/" className="text-muted-foreground hover:text-foreground transition-colors">Events & Webinars</Link></li>
              <li><Link to="/beslutsmognad/" className="text-muted-foreground hover:text-foreground transition-colors">Beslutsmognadsindex</Link></li>
              <li><Link to="/kravspecifikation/" className="text-muted-foreground hover:text-foreground transition-colors">Kravspecifikationer</Link></li>
              ...
              <li><Link to="/alla-d365-partners/" className="text-muted-foreground hover:text-foreground transition-colors">Alla D365-partners</Link></li>
              <li><Link to="/partners-per-bransch/" className="text-muted-foreground hover:text-foreground transition-colors">Partners per bransch</Link></li>
              <li><Link to="/business-central-partners-sverige/" className="text-muted-foreground hover:text-foreground transition-colors">Business Central-partners</Link></li>
              <li><Link to="/dynamics-365-sales-partners-sverige/" className="text-muted-foreground hover:text-foreground transition-colors">Dynamics 365 Sales-partners</Link></li>
              <li><Link to="/partners-sitemap/" className="text-muted-foreground hover:text-foreground transition-colors">Partners-sitemap</Link></li>
            </ul>
          </div>
