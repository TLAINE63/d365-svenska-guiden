...
int:{rec:'both',h:'Utvärdera båda – internationell tillverkning kräver noggrann analys',s:'Internationell diskret tillverkning ställer krav på multi-currency, intercompany och exportflöden. BC klarar grunderna men F&SCM erbjuder djupare global supply chain-styrning och APS. Komplexiteten i dina flöden avgör.',bc:{p:[{t:'Multi-currency & intercompany',d:'Transaktioner i olika valutor och intercompany-handel nativt.'},{t:'Exportdokumentation',d:'Grundläggande exportdokument och leveransvillkor stöds.'}],c:[{t:'Global supply chain',d:'Komplex global inköpsstyrning kräver ISV.'},{t:'Avancerad APS',d:'Multi-site kapacitetsoptimering kräver tillägg.'}]},fscm:{p:[{t:'Global supply chain',d:'End-to-end synlighet i multi-site produktion och inköp.'},{t:'Avancerad APS',d:'Constraint-baserad planering med scenarioanalys i realtid.'}],c:[{t:'Kostnad vs nytta',d:'Svårt att motivera för SMB med begränsad internationell volym.'}]},pills:['Multi-currency','Intercompany','Global MRP','Exportkontroll','Multi-site','APS'],apps:['Avalara AvaTax','CTC Global Trade','Multi Entity Mgmt','Siemens Opcenter APS']}},
...
int:{rec:'both',h:'Utvärdera båda – internationell processproduktion kräver djupanalys',s:'Internationell processindustri med export och multi-currency kan fungera i BC med ISV-tillägg, men F&SCM erbjuder inbyggd compliance (REACH, FDA) och multi-site batchproduktion. Ju fler länder och regelverk, desto starkare blir argumentet för F&SCM.',bc:{p:[{t:'Multi-currency',d:'Inköp och försäljning i olika valutor med automatisk kurs.'},{t:'ISV för formelhantering',d:'Certifierade appar täcker recept och batchoptimering.'}],c:[{t:'Global compliance',d:'REACH, FDA och EHS-krav i flera länder kräver dedikerade tillägg.'}]},fscm:{p:[{t:'Global compliance inbyggt',d:'REACH, FDA 21 CFR och kemikaliehantering utan ISV.'},{t:'Multi-site batchproduktion',d:'Styr processproduktion i flera länder i en plattform.'}],c:[{t:'Overkill för SMB',d:'Kostnad och komplexitet svår att motivera under 300 anst.'}]},pills:['Multi-currency','REACH','Formelhantering','Batchoptimering','Exportkontroll','Global compliance'],apps:['Aptean Process Mfg','Avalara AvaTax','To-Increase REACH','CTC Global Trade']}},
...
int:{rec:'both',h:'Utvärdera båda – internationell grossist behöver djupare analys',s:'Internationell grossist med global inköp och distribution kan fungera i BC med tillägg, men F&SCM erbjuder inbyggt WMS, TMS och spend-analys. Ju mer komplex supply chain, desto starkare motivering för F&SCM.',bc:{p:[{t:'Multi-currency & intercompany',d:'Inköp och försäljning i olika valutor nativt.'},{t:'Global EDI',d:'EDIFACT och ANSI X12 via certifierade tillägg.'}],c:[{t:'Global spend-analys',d:'Leverantörsportföljanalys kräver ISV.'},{t:'Avancerat TMS',d:'Flerländers fraktoptimering kräver specialiserade appar.'}]},fscm:{p:[{t:'Global inköpsstyrning',d:'Spend-analys, kontrakt och leverantörsrisk globalt.'},{t:'WMS + TMS inbyggt',d:'Ruttoptimering och wave picking utan ISV.'}],c:[{t:'Kostnad vs nytta',d:'Svårt att motivera för SMB med begränsad global volym.'}]},pills:['Multi-currency','Global EDI','Intercompany','Tullhantering','Spend-analys','TMS'],apps:['TrueCommerce EDI','Avalara AvaTax','CTC Global Trade','Lanham EDI']}},
...
int:{rec:'both',h:'Utvärdera båda – internationella IT-bolag har ett genuint val',s:'IT-bolag med internationell närvaro klarar multi-currency i BC, men komplex global staffing, SaaS revenue recognition (IFRS 15) och transfer pricing talar ofta för Project Operations / F&SCM.',bc:{p:[{t:'Multi-currency & intercompany',d:'Fakturering i lokal valuta och cross-border kostnadsallokering nativt.'},{t:'SaaS-fakturering',d:'Abonnemang och licens via certifierade appar.'}],c:[{t:'Global staffing',d:'Kompetensbaserad allokering cross-border kräver Project Operations.'},{t:'Transfer pricing',d:'Internprissättning för IT-tjänster kräver specialiserade tillägg.'}]},fscm:{p:[{t:'Project Operations',d:'Global resurspool med kompetensmatching.'},{t:'IFRS 15 inbyggt',d:'Revenue recognition för SaaS nativt.'}],c:[{t:'Kostnad',d:'Svårt att motivera för IT-SMB.'}]},pills:['Multi-currency','SaaS-faktura','Project Operations','IFRS 15','Global staffing','Intercompany'],apps:['Subscription Mgmt','Dynamics 365 Project Ops','Acterys IFRS','Vertex TP']}},
...
int:{rec:'both',h:'Utvärdera båda – internationella finansbolag har komplexa krav',s:'Internationella finansbolag med multi-currency och IFRS-rapportering behöver utvärdera båda alternativen noggrant. BC klarar grundläggande internationella flöden, men F&SCM erbjuder djupare konsolidering och regulatorisk rapportering.',bc:{p:[{t:'Multi-currency',d:'Transaktioner i olika valutor nativt.'},{t:'Intercompany',d:'Internfakturering och konsolidering för medelstora finanskoncerner.'}],c:[{t:'Regulatorisk rapportering',d:'Landspecifik finansiell rapportering kräver ISV.'},{t:'IFRS',d:'Komplex IFRS 9/17 kräver specialiserade tillägg.'}]},fscm:{p:[{t:'Global ekonomistyrning',d:'Avancerad konsolidering och internredovisning i fler länder.'},{t:'IFRS-compliance',d:'Inbyggt stöd för IFRS 9/17 och landspecifik rapportering.'}],c:[{t:'Finansspecifikt',d:'F&SCM saknar bank-, fond- och försäkringsspecifika processer.'}]},pills:['Multi-currency','Intercompany','IFRS','Regulatorisk rapport','Konsolidering','Internredovisning'],apps:['Acterys IFRS','Jet Reports','Solver BI360','Multi Entity Mgmt']}},
