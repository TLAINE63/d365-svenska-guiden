...
int:{rec:'both',h:'Utvärdera båda – internationell tillverkning kräver noggrann analys',s:'Internationell diskret tillverkning ställer krav på multi-currency, intercompany och exportflöden. BC klarar grunderna men F&SCM erbjuder djupare global supply chain-styrning och APS. Komplexiteten i era flöden avgör.',bc:{p:[{t:'Multi-currency & intercompany',d:'Transaktioner i olika valutor och intercompany-handel nativt.'},{t:'Exportdokumentation',d:'Grundläggande exportdokument och leveransvillkor stöds.'}],c:[{t:'Global supply chain',d:'Komplex global inköpsstyrning kräver ISV.'},{t:'Avancerad APS',d:'Multi-site kapacitetsoptimering kräver tillägg.'}]},fscm:{p:[{t:'Global supply chain',d:'End-to-end synlighet i multi-site produktion och inköp.'},{t:'Avancerad APS',d:'Constraint-baserad planering med scenarioanalys i realtid.'}],c:[{t:'Kostnad vs nytta',d:'Svårt att motivera för SMB med begränsad internationell volym.'}]},pills:['Multi-currency','Intercompany','Global MRP','Exportkontroll','Multi-site','APS'],apps:['Avalara AvaTax','CTC Global Trade','Multi Entity Mgmt','Siemens Opcenter APS']}},
