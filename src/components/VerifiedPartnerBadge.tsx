...
export default function VerifiedPartnerBadge({
  ...
  const sizing =
    size === "md"
      ...
      : "text-[10px] px-1.5 sm:px-2 py-0.5 sm:py-1 gap-1";
      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <span
            ...
            className={`group/vb relative inline-flex flex-wrap items-center justify-center overflow-hidden rounded-full border border-accent/60 bg-accent text-accent-foreground font-bold uppercase tracking-wide sm:tracking-[0.1em] leading-none text-center shadow-[0_2px_10px_-2px_hsl(var(--accent)/0.55)] ring-1 ring-inset ring-white/20 max-w-full ${
          ...
          >
            ...
            {!iconOnly && <span className="relative whitespace-normal">Partnerverifierad</span>}
          </span>
        </TooltipTrigger>
