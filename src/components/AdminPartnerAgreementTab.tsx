  ...
  sections: [
    {
      ...
      body:
        "Månadsavgiften är 995 kr för 1 produktområde, 1 695 kr för 2 produktområden och 1 995 kr för 3 produktområden (Sales och Customer Service buntas som en CRM-enhet).\n\nFaktureras månadsvis i förskott. Priserna anges exklusive moms.",
    },
    {
      id: crypto.randomUUID(),
