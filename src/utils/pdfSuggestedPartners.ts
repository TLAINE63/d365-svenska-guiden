...
export function appendSuggestedPartnersPage(
  ...
  }${opts.productLabel ? `produktvalet ${opts.productLabel}` : "er valda produktinriktning"} har vi valt ut ${partners.length} partners som är profilerade för det ni behöver. Ta gärna kontakt med 2–3 av dem parallellt – det ger bäst underlag att pressa både pris och funktion.`;
