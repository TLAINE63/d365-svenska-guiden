...
const STATIC_ROUTES = [
  ...
  { path: "/guider/valja-dynamics-365-sales-partner/", changefreq: "monthly", priority: "0.9" },
  { path: "/guider/valja-customer-service-field-service-partner/", changefreq: "monthly", priority: "0.9" },
  ...
  { path: "/customer-engagement/tillagg/marketing-automation/", changefreq: "monthly", priority: "0.6" },
  { path: "/customer-engagement/tillagg/contact-center/", changefreq: "monthly", priority: "0.6" },
  { path: "/customer-engagement/tillagg/telephony-cti/", changefreq: "monthly", priority: "0.6" },
  { path: "/customer-engagement/tillagg/field-service/", changefreq: "monthly", priority: "0.6" },
  { path: "/customer-engagement/tillagg/territory-maps/", changefreq: "monthly", priority: "0.6" },
  { path: "/customer-engagement/tillagg/crm-datakvalitet/", changefreq: "monthly", priority: "0.6" },
  { path: "/customer-engagement/tillagg/e-signatur-avtal/", changefreq: "monthly", priority: "0.6" },
  { path: "/business-central/tillagg/ap-automation/", changefreq: "monthly", priority: "0.6" },
  { path: "/business-central/tillagg/wms/", changefreq: "monthly", priority: "0.6" },
  { path: "/business-central/tillagg/edi-e-faktura/", changefreq: "monthly", priority: "0.6" },
  { path: "/business-central/tillagg/ehandel/", changefreq: "monthly", priority: "0.6" },
  { path: "/business-central/tillagg/rapportering-fpa/", changefreq: "monthly", priority: "0.6" },
  { path: "/business-central/tillagg/planering-produktion/", changefreq: "monthly", priority: "0.6" },
