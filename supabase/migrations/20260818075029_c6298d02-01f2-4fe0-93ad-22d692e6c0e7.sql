ALTER TABLE public.partners
  ...
  ADD COLUMN IF NOT EXISTS best_fit_for text[] NOT NULL DEFAULT '{}',
...
SELECT id, slug, name, description, logo_url, logo_dark_bg, website, email,
    ...
    positioning_statement, delivery_profile, team_size_sweden, implementations_done,
    not_a_fit, implementations_per_app, ai_summary, ai_summary_generated_at,
    ai_profile, extended_content, extended_content_updated_at, partner_size_tier,
    partner_size_tier_needs_review, ai_summary_full, best_fit_for, ai_tags
