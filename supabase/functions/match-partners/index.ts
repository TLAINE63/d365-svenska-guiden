...
2. Ge varje partner ett matchningspoäng 0-100 enligt följande viktning:
   ...
   - AI, Automation & Power Platform (bonuspoäng, max 10%): Använd fältet extended_competencies per partner (nivåer: unverified < documented_competence < documented_delivery < leading_competence). Högre nivå inom de efterfrågade områdena ger bonus. Detta får ALDRIG väga upp svagare matchning på Dynamics 365-produkt eller bransch.` : ''}${criteria.aiInterest === 'high' ? `
     - AI-kompetens (max 15%): Använd partnerns dokumenterade AI-områden och fältet extended_competencies (unverified < documented_competence < documented_delivery < leading_competence). Högre bedömd nivå och fler dokumenterade AI-projekt ger mer poäng. Får aldrig väga upp svagare Dynamics 365-matchning.` : criteria.aiInterest === 'medium' ? `
     - AI-kompetens (bonuspoäng, ej obligatoriskt): Partners med dokumenterad AI-kompetens får upp till 10 bonus-poäng baserat på bedömd nivå i extended_competencies.` : ''}${criteria.platformNeeds && criteria.platformNeeds.length > 0 ? `
