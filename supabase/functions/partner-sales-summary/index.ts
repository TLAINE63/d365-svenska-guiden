...
const APP_TO_PATHS: Record<string, string[]> = {
  ...
  "Sales": ["/d365sales", "/crm"],
  "Customer Service": ["/d365customerservice"],
  "Field Service": ["/d365fieldservice"],
  "Marketing": ["/d365marketing"],
  "Customer Insights": ["/d365marketing"],
  "Contact Center": ["/d365contactcenter"],
